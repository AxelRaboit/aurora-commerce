...
import { OrderStatus } from "@ecommerce/shared/enums/orderStatus.js";
    ...
    const availableTransitions = computed(() => {
        ...
        const map = {
                ...
                ? [
                      {
                          ...
                          label: t(
                              "backend.ecommerce.orders.actions.mark_shipped",
                          ),
                          icon: Truck,
                          color: "accent",
                      },
                ...
                : [
                      {
                          ...
                          label: t(
                              "backend.ecommerce.orders.actions.mark_fulfilled",
                          ),
                          icon: PackageCheck,
                          color: "emerald",
                      },
            ...
            [OrderStatus.Shipped]: [
                {
                    status: OrderStatus.Delivered,
                    label: t("backend.ecommerce.orders.actions.mark_delivered"),
                    icon: PackageCheck,
                    color: "emerald",
                },
            ],
