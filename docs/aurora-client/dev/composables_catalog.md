...
> ici vit dans `vendor/axelraboit/aurora/assets/shared/composables/` (alias Vite
> `@shared/composables`) ou `assets/shared/utils/` (alias `@shared/utils`).
...
```bash
ls vendor/axelraboit/aurora/assets/shared/composables/**/*.js
ls vendor/axelraboit/aurora/assets/shared/utils/**/*.js
```
