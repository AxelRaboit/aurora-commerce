...
const navItems = [
    { route: "admin_dashboard", path: props.dashboardPath, label: t("admin.nav.dashboard"), icon: LayoutDashboard, activeColor: "indigo" },
    { route: "admin_posts", path: props.postsPath, label: t("admin.nav.posts"), icon: FileText, activeColor: "indigo" },
    { route: "admin_post_types", path: props.postTypesPath, label: t("admin.nav.postTypes"), icon: Layers, activeColor: "indigo" },
    { route: "admin_media", path: props.mediaPath, label: t("admin.nav.media"), icon: Image, activeColor: "indigo" },
    { route: "admin_menus", path: props.menusPath, label: t("admin.nav.menus"), icon: Menu, activeColor: "indigo" },
    { route: "admin_taxonomies", path: props.taxonomiesPath, label: t("admin.nav.taxonomies"), icon: TagsIcon, activeColor: "indigo" },
    ...(props.isAdmin ? [{ route: "admin_users", path: props.usersPath, label: t("admin.nav.users"), icon: UsersIcon, activeColor: "indigo" }] : []),
    ...(props.commentsPath !== "" ? [{ route: "admin_comments", path: props.commentsPath, label: t("admin.nav.comments"), icon: MessageSquare, activeColor: "indigo" }] : []),
    ...(props.formsPath !== "" ? [{ route: "admin_forms", path: props.formsPath, label: t("admin.nav.forms"), icon: ClipboardList, activeColor: "indigo" }] : []),
    ...(props.settingsPath !== "" ? [{ route: "admin_settings", path: props.settingsPath, label: t("admin.nav.settings"), icon: Settings, activeColor: "indigo" }] : []),
    ...(props.themesPath !== "" ? [{ route: "admin_themes", path: props.themesPath, label: t("admin.nav.themes"), icon: Palette, activeColor: "indigo" }] : []),
    ...(props.isDev ? [{ route: "dev_", path: props.administrationPath, label: t("admin.nav.administration"), icon: Shield, activeColor: "rose" }] : []),
];
