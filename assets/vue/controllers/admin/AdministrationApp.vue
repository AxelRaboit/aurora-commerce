        ...
        <div v-if="props.tab === 'parameters'" class="space-y-3">
            <div class="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-2">
                <AppInput
                    ...
                    v-on:keyup.enter="parameters.performSearch"
                />
                <AppButton variant="primary" size="md" class="w-full sm:w-auto" v-on:click="parameters.performSearch">{{ t('admin.parameters.search') }}</AppButton>
            </div>
