...
<template>
    <form class="space-y-3" v-on:submit.prevent="$emit('submit')">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
                <label class="block text-sm font-medium text-secondary mb-1">{{ t("comment.name") }}</label>
                <input
                    :class="inputClass"
                    type="text"
                    :value="authorName"
            ...
            <div>
                <label class="block text-sm font-medium text-secondary mb-1">{{ t("comment.email") }}</label>
                <input
                    :class="inputClass"
                    type="email"
                    :value="authorEmail"
        ...
        <div>
            <label class="block text-sm font-medium text-secondary mb-1">{{ t("comment.content") }}</label>
            <textarea
