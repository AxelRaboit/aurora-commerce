        ...
        <template v-if="report">
            ...
            <div class="bg-surface border border-line/60 rounded-xl overflow-hidden">
                ...
                >
                    ...
                    <span class="font-semibold text-primary flex-1 text-left">{{ t('backend.billing.compliance.checks.sequence.title') }}</span>
                    <span class="text-sm text-muted">
                        {{ report.checks.sequence.gapCount === 0
                            ? t('backend.billing.compliance.checks.sequence.noGaps')
                            : t('backend.billing.compliance.checks.sequence.gaps', { n: report.checks.sequence.gapCount }) }}
                    </span>
            ...
            <div class="bg-surface border border-line/60 rounded-xl overflow-hidden">
                ...
                >
                    ...
                    <span class="font-semibold text-primary flex-1 text-left">{{ t('backend.billing.compliance.checks.archive.title') }}</span>
                    <span class="text-sm text-muted">
                ...
                <div v-if="expanded.archive" class="border-t border-line/40">
                    ...
                    <p v-else class="px-6 pb-4 text-sm text-emerald-400">{{ t('backend.billing.compliance.checks.archive.ok') }}</p>
                </div>
            </div>
            ...
            <div class="bg-surface border border-line/60 rounded-xl overflow-hidden">
                ...
                >
                    ...
                    <span class="font-semibold text-primary flex-1 text-left">{{ t('backend.billing.compliance.checks.audit.title') }}</span>
                    <span class="text-sm text-muted">
                ...
                <div v-if="expanded.audit" class="border-t border-line/40">
                    ...
                    <p v-else class="px-6 pb-4 text-sm text-emerald-400">{{ t('backend.billing.compliance.checks.audit.ok') }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div class="bg-surface border border-line/60 rounded-xl p-4 text-center">
                    ...
                    <p class="text-xs text-muted mt-1">{{ t('backend.billing.compliance.stats.totalIssued') }}</p>
                </div>
                <div v-for="(count, status) in report.stats.byStatus" :key="status" class="bg-surface border border-line/60 rounded-xl p-4 text-center">
                    ...
                    <p class="text-xs text-muted mt-1">{{ t('backend.billing.invoices.status.' + status) }}</p>
                </div>
            </div>
        </template>
    </div>
