 ...
 */
export function useOcrJobs(jobsRef, { statusUrlTemplate, retryUrlTemplate, intervalMs = 4000 } = {}) {
    const { t } = useI18n();
    ...
    async function retry(job) {
        if (!retryUrlTemplate) {
            throw new Error("useOcrJobs: retryUrlTemplate is required to call retry()");
        }
