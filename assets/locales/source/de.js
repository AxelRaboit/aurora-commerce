export default {
    admin: {
        ...
        media: {
            ...
            checkingUsage: "Verwendungen werden geprüft…",
            usageNone: "Dieses Medium wird nirgends verwendet.",
            usageWarning:
                "Dieses Medium wird aktuell an {count} Stelle(n) verwendet. Beim Löschen werden diese unterbrochen:",
            deleteAnyway: "Trotzdem löschen",
            usageGroups: {
                "post.featured": "Beiträge (Hauptbild)",
                "post.content": "Beiträge (im Inhalt)",
                "gallery.cover": "Galerien (Titelbild)",
                "gallery.item": "Galerien (Fotos)",
                "branding.setting": "Markenidentität",
                other: "Andere",
            },
        ...
        ecommerce: {
            listings: {
                ...
                searchPlaceholder: "Nach Titel, Slug oder Referenz suchen…",
                title: "Titel",
                slug: "Slug",
        ...
        erp: {
            products: {
                ...
                reference: "Referenz",
                referencePlaceholder: "z. B. STUHL-001",
                referenceAutoPlaceholder: "Auto-generiert wenn leer",
                image: "Bild",
                chooseImage: "Bild auswählen",
                ...
                errors: {
                    name_required: "Name ist erforderlich.",
                    reference_required: "Referenz ist erforderlich.",
                    reference_invalid:
                        "Ungültige Referenz (Buchstaben, Ziffern, Bindestriche).",
                    reference_taken: "Diese Referenz ist bereits vergeben.",
    ...
    shared: {
        ...
        media: {
            ...
            picker: {
                title: "Medium auswählen",
                search: "Nach Name oder Alt suchen…",
                allFolders: "Alle Medien",
                rootFolder: "Stamm",
                empty: "Kein Medium gefunden",
                select: "Auswählen",
                ...
                folder: "Ordner",
                alt: "Alt-Text",
                altPlaceholder: "Beschreibe das Bild für Screenreader und SEO",
                caption: "Beschriftung",
                captionPlaceholder: "Unter dem Bild angezeigte Beschriftung",
