export default {
    ...
    admin: {
        ...
        users: {
            ...
            inviteMessagePlaceholder: "Fügen Sie der Einladung eine Nachricht bei…",
        ...
        themes: {
            ...
            headerMediaHint: "Die ID finden Sie unter Medien → Medium öffnen → ID-Feld.",
            headerTextPlaceholder: "Meine Website",
            configHint: "Verfügbare Variablen: --th-bg, --th-surface, --th-surface-2, --th-primary, --th-secondary, --th-muted, --th-accent, --th-accent-hover",
            configPlaceholder: '{\n  "--th-accent": "#6366f1"\n}',
            configJsonError: "Die Konfigurations-JSON ist ungültig.",
            deleteConfirm: 'Design "{name}" löschen? Diese Aktion ist unwiderruflich.',
            cannotDeleteDefault: "Das Standard-Design kann nicht gelöscht werden.",
            ...
            errors: {
                slug_invalid: "Der Slug darf nur Kleinbuchstaben, Zahlen und Bindestriche enthalten.",
