    ...
    admin: {
        ...
        postTypes: {
            ...
            fields: {
                ...
                deleteConfirm: "Supprimer « {label} » ? Les valeurs existantes seront perdues.",
                name: "Nom technique",
                label: "Libellé",
                type: "Type",
                required: "Requis",
                ...
                selectChoicesHint: "Format : valeur|libellé (si le libellé est omis, la valeur est utilisée)",
        ...
        taxonomies: {
            ...
            deleteTaxonomyConfirm: "Supprimer « {label} » ? Tous les termes associés seront supprimés.",
            ...
            terms: {
                ...
                deleteTermConfirm: "Supprimer « {name} » ? Les enfants directs seront rattachés au parent.",
                name: "Nom",
                slug: "Slug",
                description: "Description",
                parent: "Parent",
        ...
        media: {
            ...
            altWarning: "Certains médias n'ont pas de texte alternatif. Clique dessus pour le renseigner (accessibilité et SEO).",
        ...
        users: {
            ...
            inviteMessagePlaceholder: "Ajoutez un message pour accompagner l'invitation…",
        ...
        themes: {
            ...
            headerMediaHint: "Trouvez l'ID dans Médias → ouvrez un média → champ ID.",
            ...
            deleteConfirm: 'Supprimer le thème "{name}" ? Cette action est irréversible.',
            ...
            errors: {
                slug_invalid: "Le slug ne peut contenir que des lettres minuscules, chiffres et tirets.",
