    ...
    admin: {
        ...
        postTypes: {
            ...
            fields: {
                ...
                add: "Add field",
                edit: "Edit field",
                deleteConfirm: "Delete \"{label}\"? Existing values will be lost.",
                name: "Technical name",
                label: "Label",
                type: "Type",
                required: "Required",
                ...
                selectChoicesHint: "Format: value|label (if label is omitted, value is used)",
        ...
        taxonomies: {
            ...
            deleteTaxonomyConfirm: "Delete \"{label}\"? All related terms will be removed.",
            ...
            terms: {
                ...
                addTerm: "Add",
                editTerm: "Edit term",
                deleteTermConfirm: "Delete \"{name}\"? Direct children will be re-parented.",
                name: "Name",
                slug: "Slug",
                description: "Description",
                parent: "Parent",
        ...
        media: {
            ...
            altWarning: "Some media have no alt text. Click to set it (accessibility & SEO).",
        ...
        users: {
            ...
            inviteMessagePlaceholder: "Add a message to accompany the invitation…",
            allRoles: "All roles",
            status: "Status",
            enable: "Enable",
            disable: "Disable",
        ...
        themes: {
            ...
            configHint: "Available variables: --th-bg, --th-surface, --th-surface-2, --th-primary, --th-secondary, --th-muted, --th-accent, --th-accent-hover",
            configPlaceholder: '{\n  "--th-accent": "#6366f1"\n}',
            configJsonError: "The configuration JSON is invalid.",
            deleteConfirm: 'Delete theme "{name}"? This action is irreversible.',
