...
vi.mock("@/shared/utils/data/blocksRenderer.js", () => ({
    renderBlocks: (blocks) =>
    ...
    admin: {
        posts: {
            merge: {
                ...
                use: "Utiliser",
                deleted: "Supprimé",
                showUnchanged: "Afficher",
                hideUnchanged: "Masquer",
                acceptAllMine: "Tout à gauche",
                acceptAllTheirs: "Tout à droite",
                nothingToShow: "Rien",
                unresolvedCount: "{count} conflits",
                unresolvedError: "Il reste des conflits",
