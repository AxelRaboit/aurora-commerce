...
de build régénéré par `make translation`. Ne jamais toucher `src/Core/Frontend/locales/generated/*.json`.
...
make translation   # régénère src/Core/Frontend/locales/generated/{fr,en}.json
```
