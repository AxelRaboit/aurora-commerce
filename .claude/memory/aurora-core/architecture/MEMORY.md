...
- [decision_media_ged_merge_done.md](decision_media_ged_merge_done.md) — fusion Media→GED ✅ terminée (toutes phases, 2026-05-30) : `Document` est l'unique entité-fichier d'Aurora. Inclut le résumé Phase 1 + pièges/migrations à connaître.
