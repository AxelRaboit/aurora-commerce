...
5. **Sandbox** : symfony/flex ne peut pas joindre les recipes (404) → `--no-plugins` a fait dériver symfony en 8.x ; l'app boote+build quand même. En install réelle, garder flex (pin symfony 7.4).
