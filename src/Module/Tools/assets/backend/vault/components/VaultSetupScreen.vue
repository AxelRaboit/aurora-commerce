...
import { useVaultSetup } from '@tools/backend/vault/composables/useVaultSetup.js';
...
import VaultPasswordStrengthBar from '@tools/backend/vault/components/VaultPasswordStrengthBar.vue';
