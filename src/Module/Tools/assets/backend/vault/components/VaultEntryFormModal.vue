...
import { ICONS, getRecordType, PASSWORD_FIELDS, TEXTAREA_FIELDS } from '@tools/backend/vault/utils/recordTypes.js';
import { useRevealedFields } from '@tools/backend/vault/composables/useRevealedFields.js';
import { useVaultPasswordPicker } from '@tools/backend/vault/composables/useVaultPasswordPicker.js';
import { useVaultFolderOptions } from '@tools/backend/vault/composables/useVaultFolderOptions.js';
import VaultTypePickerModal from '@tools/backend/vault/components/VaultTypePickerModal.vue';
import VaultPasswordPickerModal from '@tools/backend/vault/components/VaultPasswordPickerModal.vue';
