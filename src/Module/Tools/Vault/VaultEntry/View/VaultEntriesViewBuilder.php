...
namespace Aurora\Module\Tools\Vault\VaultEntry\View;
...
use Aurora\Module\Tools\Vault\VaultFolder\Serializer\VaultFolderSerializerInterface;
...
use Aurora\Module\Tools\Vault\VaultUserConfig\Serializer\VaultUserConfigSerializerInterface;
...
final readonly class VaultEntriesViewBuilder
{
    ...
    public function indexView(CoreUserInterface $user): array
    {
        ...
        return [
            ...
            'setupPath' => $this->urlGenerator->generate('backend_tools_vault_config_setup'),
            'changeMasterPasswordPath' => $this->urlGenerator->generate('backend_tools_vault_config_change_master_password'),
            'destroyVaultPath' => $this->urlGenerator->generate('backend_tools_vault_config_destroy'),
            'createEntryPath' => $this->urlGenerator->generate('backend_tools_vault_entries_create'),
            'updateEntryPath' => $this->urlGenerator->generate('backend_tools_vault_entries_update', ['id' => '__id__']),
            'deleteEntryPath' => $this->urlGenerator->generate('backend_tools_vault_entries_delete', ['id' => '__id__']),
            'toggleFavoritePath' => $this->urlGenerator->generate('backend_tools_vault_entries_toggle_favorite', ['id' => '__id__']),
            'moveEntryPath' => $this->urlGenerator->generate('backend_tools_vault_entries_move', ['id' => '__id__']),
            'createFolderPath' => $this->urlGenerator->generate('backend_tools_vault_folders_create'),
            'updateFolderPath' => $this->urlGenerator->generate('backend_tools_vault_folders_update', ['id' => '__id__']),
            'deleteFolderPath' => $this->urlGenerator->generate('backend_tools_vault_folders_delete', ['id' => '__id__']),
        ];
    }
}
