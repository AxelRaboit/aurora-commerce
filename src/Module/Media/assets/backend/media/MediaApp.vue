...
import { useMediaUpload } from "@media/backend/media/composables/useMediaUpload.js";
import { useMediaEdit } from "@media/backend/media/composables/useMediaEdit.js";
import { useMediaDelete } from "@media/backend/media/composables/useMediaDelete.js";
import { useMediaFolders } from "@media/backend/media/composables/useMediaFolders.js";
import { useMediaBulkActions } from "@media/backend/media/composables/useMediaBulkActions.js";
import { useMediaDragDrop } from "@media/backend/media/composables/useMediaDragDrop.js";
...
const props = defineProps({
    ...
    deletePath: { type: String, default: "/backend/media/media/__id__/delete" },
    movePath: { type: String, default: "/backend/media/media/__id__/move" },
    folderCreatePath: { type: String, default: "/backend/media/media/folders" },
    folderEditPath: { type: String, default: "/backend/media/media/folders/__id__/edit" },
    folderDeletePath: { type: String, default: "/backend/media/media/folders/__id__/delete" },
    reorderPath: { type: String, default: "/backend/media/media/reorder" },
    bulkDeletePath: { type: String, default: "/backend/media/media/bulk-delete" },
    listPath: { type: String, default: "/backend/media/media/list" },
    bulkMovePath: { type: String, default: "/backend/media/media/bulk-move" },
    cropPath: { type: String, default: "/backend/media/media/__id__/crop" },
