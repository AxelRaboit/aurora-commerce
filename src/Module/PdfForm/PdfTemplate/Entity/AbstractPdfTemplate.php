...
abstract class AbstractPdfTemplate implements PdfTemplateInterface
{
    ...
    #[ORM\Column(length: 20, enumType: PdfTemplateStatusEnum::class)]
    protected PdfTemplateStatusEnum $status = PdfTemplateStatusEnum::Draft;
    ...
    /** @var Collection<int, PdfTemplateFieldInterface> */
    #[ORM\OneToMany(targetEntity: PdfTemplateFieldInterface::class, mappedBy: 'template', cascade: ['persist', 'remove'], orphanRemoval: true)]
