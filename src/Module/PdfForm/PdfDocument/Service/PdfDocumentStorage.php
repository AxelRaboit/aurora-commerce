...
namespace Aurora\Module\PdfForm\PdfDocument\Service;
...
final readonly class PdfDocumentStorage
{
    ...
    public function absolutePath(PdfDocumentInterface $document): ?string
    {
    ...
    public function fileExists(PdfDocumentInterface $document): bool
    {
