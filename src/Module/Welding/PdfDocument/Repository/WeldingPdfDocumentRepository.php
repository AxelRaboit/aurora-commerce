...
namespace Aurora\Module\Welding\PdfDocument\Repository;
...
/** @extends ResolveTargetEntityRepository<WeldingPdfDocumentInterface> */
class WeldingPdfDocumentRepository extends ResolveTargetEntityRepository
{
    use PaginationTrait;

    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, WeldingPdfDocument::class, WeldingPdfDocumentInterface::class);
    }

    /** @return WeldingPdfDocumentInterface[] */
