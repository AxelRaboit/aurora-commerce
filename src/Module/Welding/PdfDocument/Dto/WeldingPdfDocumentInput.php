...
class WeldingPdfDocumentInput implements WeldingPdfDocumentInputInterface
{
    public function __construct(
        #[Assert\NotBlank(message: 'backend.welding.pdf_documents.errors.template_required')]
        #[Assert\Positive]
