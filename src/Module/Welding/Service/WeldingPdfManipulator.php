 ...
 *   optionally flattens.
 */
#[AsAlias(WeldingPdfManipulatorInterface::class)]
final class WeldingPdfManipulator implements WeldingPdfManipulatorInterface
{
    private const string TMP_VALUES_PREFIX = 'aurora_welding_pdf_values_';
