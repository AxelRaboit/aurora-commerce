...
use Aurora\Module\Welding\WorkflowStepPdfTemplate\Dto\WeldingWorkflowStepPdfTemplateInputFactoryInterface;
use Aurora\Module\Welding\WorkflowStepPdfTemplate\Entity\WeldingWorkflowStepPdfTemplateInterface;
use Aurora\Module\Welding\WorkflowStepPdfTemplate\Manager\WeldingWorkflowStepPdfTemplateManagerInterface;
...
class WeldingWorkflowStepPdfTemplatesController extends AbstractController
{
    use JsonRequestTrait;
    use JsonResponseTrait;

    public function __construct(
        protected readonly WeldingWorkflowStepPdfTemplateRepository $repository,
        protected readonly WeldingWorkflowStepPdfTemplateSerializerInterface $serializer,
        protected readonly WeldingWorkflowStepPdfTemplateManagerInterface $manager,
        protected readonly WeldingWorkflowStepPdfTemplateInputFactoryInterface $inputFactory,
    ...
    #[IsGranted('welding.workflow_templates.edit')]
    public function update(WeldingWorkflowStepPdfTemplateInterface $entry, Request $request): JsonResponse
    {
        $input = $this->inputFactory->fromArray($this->decodeJson($request));
        $errors = $this->payloadValidator->errors($input);
        if ([] !== $errors) {
    ...
    #[IsGranted('welding.workflow_templates.edit')]
    public function delete(WeldingWorkflowStepPdfTemplateInterface $entry): JsonResponse
    {
