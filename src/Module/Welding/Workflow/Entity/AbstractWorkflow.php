...
abstract class AbstractWorkflow implements WorkflowInterface
{
    ...
    protected ?WorkflowTemplateInterface $template = null;

    #[ORM\ManyToOne(targetEntity: EmployeeInterface::class)]
    #[ORM\JoinColumn(nullable: true, onDelete: 'SET NULL')]
    protected ?EmployeeInterface $assignee = null;

    #[ORM\Column(length: 30, enumType: WorkflowStatusEnum::class, options: ['default' => 'draft'])]
    protected WorkflowStatusEnum $status = WorkflowStatusEnum::Draft;
    ...
    public function getTemplate(): ?WorkflowTemplateInterface
    {
        return $this->template;
    }

    public function setTemplate(?WorkflowTemplateInterface $template): static
    {
    ...
    public function setStatus(WorkflowStatusEnum $status): static
    {
        $this->status = $status;
