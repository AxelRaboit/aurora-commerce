...
/**
 * Gates fine-grained Workflow / WorkflowStep actions on top of the
...
final class WorkflowVoter extends Voter
{
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return $subject instanceof WorkflowInterface || $subject instanceof WorkflowStepInterface;
    }
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token, ?Vote $vote = null): bool
    {
        ...
        $workflow = $subject instanceof WorkflowStepInterface ? $subject->getWorkflow() : $subject;
    ...
    private function isAssignee(WorkflowInterface $workflow, User $user): bool
    {
