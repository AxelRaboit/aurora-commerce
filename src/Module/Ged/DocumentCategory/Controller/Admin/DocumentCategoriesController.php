...
namespace Aurora\Module\Ged\DocumentCategory\Controller\Admin;
...
#[Route('/admin/ged/categories', name: 'ged_categories')]
...
final class DocumentCategoriesController extends AbstractController
{
    ...
    {
        return $this->render('@Ged/admin/categories/index.html.twig', $this->viewBuilder->indexView($pagination));
    }
