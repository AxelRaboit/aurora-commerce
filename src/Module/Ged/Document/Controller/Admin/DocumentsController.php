...
namespace Aurora\Module\Ged\Document\Controller\Admin;
...
#[Route('/backend/ged/documents', name: 'ged_documents')]
...
final class DocumentsController extends AbstractController
{
    ...
    {
        return $this->render('@Ged/admin/documents/index.html.twig', $this->viewBuilder->indexView($pagination));
    }
