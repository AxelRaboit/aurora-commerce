...
abstract class AbstractInvoiceLine implements InvoiceLineInterface
{
    #[ORM\ManyToOne(targetEntity: InvoiceInterface::class, inversedBy: 'lines')]
    ...
    protected string $quantity = '1.0000';
