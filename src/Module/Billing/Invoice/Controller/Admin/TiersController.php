...
#[Route('/admin/billing/tiers', name: 'billing_tiers')]
...
final class TiersController extends AbstractController
{
    ...
    public function update(Tiers $tiers, Request $request): JsonResponse
    {
        ...
        if (!is_array($payload) || !isset($payload['field'])) {
            return $this->jsonInvalidInput(['field' => 'admin.billing.tiers.update.fieldRequired']);
        }
    ...
    public function delete(Tiers $tiers): JsonResponse
    {
        try {
            ...
            return $this->jsonFailure('admin.billing.tiers.deleteError', extra: ['detail' => $throwable->getMessage()]);
        }
