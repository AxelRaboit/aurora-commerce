...
#[Route('/backend/crm/deals', name: 'crm_deals')]
...
final class DealsController extends AbstractController
{
    ...
    {
        return $this->render('@Crm/admin/deals/index.html.twig', $this->viewBuilder->indexView($pagination, initialView: 'list', kanbanColumns: null));
    }
