...
namespace Aurora\Core\Agency\Controller\Admin;
...
#[Route('/backend/agencies', name: 'admin_agencies')]
...
final class AgenciesController extends AbstractController
{
    ...
    {
        return $this->render('@Core/admin/agencies/index.html.twig', $this->viewBuilder->indexView());
    }
