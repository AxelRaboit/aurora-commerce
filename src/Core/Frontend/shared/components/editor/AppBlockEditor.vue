            ...
            messages: {
                ui: {
                    ...
                    popover: {
                        ...
                        "Nothing found. Try searching for something else.": t("backend.editor.ui.popover.nothingFoundExtended"),
                    },
                },
                toolNames: {
                    "Text":           t("backend.editor.toolNames.text"),
                    "Heading":        t("backend.editor.toolNames.heading"),
                    "List":           t("backend.editor.toolNames.list"),
                    "Ordered List":   t("backend.editor.toolNames.orderedList"),
                    "Unordered List": t("backend.editor.toolNames.unorderedList"),
                    "Checklist":      t("backend.editor.toolNames.checklist"),
                    "Quote":          t("backend.editor.toolNames.quote"),
                    "Code":           t("backend.editor.toolNames.code"),
                    "Delimiter":      t("backend.editor.toolNames.delimiter"),
                    "Table":          t("backend.editor.toolNames.table"),
                    "Image":          t("backend.editor.toolNames.image"),
                    "Embed":          t("backend.editor.toolNames.embed"),
                    "Marker":         t("backend.editor.toolNames.marker"),
                    "InlineCode":     t("backend.editor.toolNames.inlineCode"),
                    "Underline":      t("backend.editor.toolNames.underline"),
                    "Strikethrough":  t("backend.editor.toolNames.strikethrough"),
                    "Text Color":     t("backend.editor.toolNames.textColor"),
                    "Background Color": t("backend.editor.toolNames.textBackground"),
                    "Font Size":      t("backend.editor.toolNames.fontSize"),
                    "Clear formatting": t("backend.editor.toolNames.clearFormatting"),
                    "Callout":        t("backend.editor.toolNames.callout"),
                    "Image + Text":   t("backend.editor.toolNames.mediaText"),
                    "Two Columns":    t("backend.editor.toolNames.twoColumn"),
                    "Liste d'articles": t("backend.editor.toolNames.postsList"),
                },
                blockTunes: {
                    delete: {
                        Delete:           t("backend.editor.blockTunes.delete.Delete"),
        ...
        tools: {
            ...
            image: {
                ...
                config: {
                    ...
                    captionPlaceholder: t("backend.editor.image.captionPlaceholder"),
                },
            },
            embed: {
                class: Embed,
            ...
            quote: {
                ...
                config: {
                    ...
                    captionPlaceholder: t("backend.editor.quote.captionPlaceholder"),
                },
            },
            delimiter: Delimiter,
            code: Code,
            ...
            callout: {
                class: CalloutBlock,
                config: {
                    titlePlaceholder:   t("backend.editor.callout.titlePlaceholder"),
                    messagePlaceholder: t("backend.editor.callout.messagePlaceholder"),
                },
            },
            ...
            mediaText: {
                ...
                config: {
                    flipLeft:           t("backend.editor.mediaText.flipLeft"),
                    flipRight:          t("backend.editor.mediaText.flipRight"),
                    captionPlaceholder: t("backend.editor.mediaText.captionPlaceholder"),
                    textPlaceholder:    t("backend.editor.mediaText.textPlaceholder"),
                    urlPlaceholder:     t("backend.editor.mediaText.urlPlaceholder"),
                    changeUrl:          t("backend.editor.mediaText.changeUrl"),
                    confirm:            t("backend.editor.mediaText.confirm"),
                    browse:             t("backend.editor.mediaText.browse"),
                    orLabel:            t("backend.editor.mediaText.or"),
                    mediaIdPlaceholder: t("backend.editor.mediaText.mediaIdPlaceholder"),
