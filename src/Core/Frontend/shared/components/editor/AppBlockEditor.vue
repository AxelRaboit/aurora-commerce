    ...
    editor = new EditorJS({
        ...
        i18n: {
            messages: {
                ...
                toolNames: {
                    ...
                    "Ordered List":   t("backend.editor.toolNames.ordered_list"),
                    "Unordered List": t("backend.editor.toolNames.unordered_list"),
                    ...
                    "InlineCode":     t("backend.editor.toolNames.inline_code"),
                    "Underline":      t("backend.editor.tool_names.underline"),
                    "Strikethrough":  t("backend.editor.tool_names.strikethrough"),
                    "Text Color":     t("backend.editor.toolNames.text_color"),
                    "Background Color": t("backend.editor.toolNames.text_background"),
                    "Font Size":      t("backend.editor.toolNames.font_size"),
                    "Clear formatting": t("backend.editor.toolNames.clear_formatting"),
                    "Callout":        t("backend.editor.tool_names.callout"),
                    "Image + Text":   t("backend.editor.toolNames.media_text"),
                    "Two Columns":    t("backend.editor.toolNames.two_column"),
                    "Liste d'articles": t("backend.editor.toolNames.posts_list"),
                },
                blockTunes: {
                    delete: {
        ...
        tools: {
            ...
            mediaText: {
                ...
                config: {
                    flipLeft:           t("backend.editor.mediaText.flip_left"),
                    flipRight:          t("backend.editor.mediaText.flip_right"),
                    captionPlaceholder: t("backend.editor.mediaText.caption_placeholder"),
                    textPlaceholder:    t("backend.editor.mediaText.text_placeholder"),
                    urlPlaceholder:     t("backend.editor.mediaText.url_placeholder"),
                    changeUrl:          t("backend.editor.mediaText.change_url"),
                    ...
                    mediaIdPlaceholder: t("backend.editor.mediaText.media_id_placeholder"),
                    mediaIdNotFound:    t("backend.editor.mediaText.media_id_not_found"),
                },
            },
