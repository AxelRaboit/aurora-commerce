...
namespace Aurora\Tests\Unit\Module\PdfForm\Serializer;
...
final class PdfTemplateSerializerTest extends TestCase
{
    ...
    private function makeTemplateStub(bool $requiresSignature = false, bool $flattenOnGenerate = false): PdfTemplateInterface
    {
        ...
        $template->method('getStatus')->willReturn(PdfTemplateStatusEnum::Active);
    ...
    public function testSerializeStatusLabelIsTranslated(): void
    {
        ...
        self::assertSame(PdfTemplateStatusEnum::Active->getLabelKey(), $result['statusLabel']);
    }
}
