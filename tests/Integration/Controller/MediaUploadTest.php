...
final class MediaUploadTest extends IntegrationTestCase
{
    ...
    {
        $this->client->request(HttpMethodEnum::Post->value, $this->urlGenerator->generate('backend_media_media_upload'));
    ...
    public function testUploadAttachesToFolderWhenFolderIdProvided(): void
    {
        ...
        $this->client->request(
            ...
            $this->urlGenerator->generate('backend_media_media_upload'),
    ...
    private function createFolder(string $name): MediaFolder
    {
        $this->client->request(
            HttpMethodEnum::Post->value,
            $this->urlGenerator->generate('backend_media_media_folder_create'),
            [],
            [],
