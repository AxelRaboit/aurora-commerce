...
final class CommentsControllerTest extends IntegrationTestCase
{
    ...
    {
        $this->client->request(HttpMethodEnum::Get->value, $this->urlGenerator->generate('backend_editorial_comments_list'));
    ...
    {
        $this->client->request(HttpMethodEnum::Get->value, $this->urlGenerator->generate('backend_editorial_comments_list', ['status' => 'pending']));
        $response = $this->client->getResponse();
    ...
    {
        $this->client->request(HttpMethodEnum::Post->value, $this->urlGenerator->generate('backend_editorial_comments_approve', ['id' => $this->comment->getId()]));
        $response = $this->client->getResponse();
    ...
    {
        $this->client->request(HttpMethodEnum::Post->value, $this->urlGenerator->generate('backend_editorial_comments_spam', ['id' => $this->comment->getId()]));
        $response = $this->client->getResponse();
    ...
    public function testDeleteComment(): void
    {
        ...
        $this->client->request(HttpMethodEnum::Post->value, $this->urlGenerator->generate('backend_editorial_comments_delete', ['id' => $commentId]));
        $response = $this->client->getResponse();
    ...
    {
        $this->client->request(HttpMethodEnum::Post->value, $this->urlGenerator->generate('backend_editorial_comments_toggle_moderation'));
        $response = $this->client->getResponse();
